...
This is a simple web demo of semantic search (search by meaning) on project abstracts products using Solr and BERT embeddings.
...
For example, for the "*covid -19*" query, the system will return products with similar reviews like "*covid-19 projects*" and "*corona virus*," 
which may not be retrieved if only textual similarity is used.

**Web Demo: https://chs-solr-sbert-039e37ef2160.herokuapp.com/**
...
* We can test it our with a small part of Amazon Fine Food Reviews (since CHS-ASU data is publicaly not available )dataset in this application for semantic search, the full dataset can be found [here](https://www.kaggle.com/snap/amazon-fine-food-reviews)
